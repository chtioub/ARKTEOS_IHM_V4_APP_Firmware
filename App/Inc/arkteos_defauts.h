...
//  DEFINES
/*****************************************************************************/
#define NB_MAX_DEFAUTS          1000    // Num�ro max de d�faut
#define MAX_DEFAUTS_CARTE       5       // Nombre de d�fauts max par carte
// Masque et attributs
#define MASK_DEFAUT             0x03FF  // Masque des d�fauts
#define DEFAUT_NV_IHM           0x8000  // Non visible depuis l'IHM
#define DEFAUT_NV_TH            0x4000  // Non visible depuis le Thermostat
#define DEFAUT_BLOQUANT         0x0800  // Entraine l'arr�t de la demande et fait passer la regulation en mode secours si l'option "En Cas Defaut PAC" est activ�
...
typedef enum
{
    ...
    // Erreurs Temp�ratures int�rieures
    ...
    // Erreurs
    ERR_SYSTEM                  = 114 | T_DEF_DEFAUT | DEFAUT_BLOQUANT,     // Erreur system (longueur de trame incoh�rente, etc ....)
    ...
    // Alertes temp�ratures int�rieures
    ...
    // Alerte de puissance de r�ception des sondes RF
...
typedef enum
{
    ...
    ERR_IPM_SURINTENSITE        = 857 | DEFAUT_NV_TH | DEFAUT_NV_IHM,                           // PW : IPM surintensit�
    ERR_PILOT_COMP              = 858,                                                          // PW : Erreur pilotage compresseur
    ERR_COMP_SURINTENSITE       = 859,                                                          // PW : Surintensit� compresseur
    ERR_INPUT_PHASE_LACK        = 860,                                                          // PW : Manque un Phase
    ERR_IPM_ECHANTILLONAGE      = 861,                                                          // PW : IPM erreur �chantillonnage
    ...
    ERR_PFC_SURINTENSITE        = 866,                                                          // PW : PFC  surintensit�
    ERR_TEMP_RADIATEUR          = 867,                                                          // PW : Erreur Sonde temp�rature radiateur
    ...
    ALERTE_COMP_SURINTENSITE    = 870 | DEFAUT_NV_IHM | DEFAUT_NV_HISTORIQUE,                   // PW : Alerte surintensit� compresseur
    ALERTE_TEMP_RADIATEUR_ELEVEE = 871 | DEFAUT_NV_IHM | DEFAUT_NV_HISTORIQUE,                  // PW : Alerte Radiateur PW temp�rature �lev�e
    ALERTE_PFC_SURINTENSITE     = 872 | DEFAUT_NV_IHM | DEFAUT_NV_HISTORIQUE,                   // PW : Alerte PFC surintensit�
...
typedef enum
{
    ...
    ERR_MITSU_UD                = 361 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // UD Protection li�e a une surchauffe (TH3)",
    ERR_MITSU_A0_A8             = 362 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // A0 a A8 Erreur de communication sur M-NET",
    ERR_MITSU_E0                = 363 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // E0 Erreur Communication avec T�l�commmande",
    ERR_MITSU_E1_E2             = 364 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // E1-E2 Anomalie de la Telecommande",
    ERR_MITSU_E3                = 365 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // E3 Err. Communication T�l�commande Transmission",
    ERR_MITSU_E4                = 366 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // E4 Err. Signal T�l�commande (avec UI)",
    ...
    ERR_MITSU_EA                = 372 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // EA Cablage des modules en inad�quation avec\nla qt� unit� int�rieure",
    ERR_MITSU_EB                = 373 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // EB Erreur sur cablage des modules internes et\nexternes ",
    ERR_MITSU_EC                = 374 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // EC Delai de demarrage �coul�",
    ERR_MITSU_ED                = 375 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // ED Erreur de communication entre cartes\npilotage et Power (unit� externe)",
    ERR_MITSU_EF                = 376 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // EF Code Erreur ind�fini",
    ...
    ERR_MITSU_FB                = 380, // FB Carte Controller PAC module int�rieur\nen defaut",
    ERR_MITSU_P1                = 381, // P1 Anomalie sur thermostat interieur (TH1)",
    ERR_MITSU_P2                = 382, // P2 Anomalie sur capteur de temperature\nliquide (TH2)",
    ERR_MITSU_P4                = 383, // P4 Anomalie du capteur d'�vacuation (DS)\nou Contact (FS) ",
    ERR_MITSU_P5                = 384, // P5 Protection d�bordement de l'evacuation\ninterieure",
    ...
    ERR_MITSU_U1                = 388 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // U1 Pression excessive (klixon HP 63H activ�)",
    ERR_MITSU_U2                = 389 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // U2 D�faut du Thermostat de corps et\nde la T� de refoulement (TH4)",
    ERR_MITSU_U3                = 390 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // U3 Defaut sonde T� unit� exterieure\n(TH4)  ou (TH32)",
    ERR_MITSU_U4                = 391 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // U4 Defaut sonde T� unit� exterieure\n(TH3, TH6, TH7 ou TH8)",
    ...
    ERR_MITSU_U7                = 394 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // U7 Surchauffe li�e � une T�  BP trop basse",
    ERR_MITSU_U8                = 395 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // U8 Probl�me sur Ventilateur Unit� Ext�rieure",
    ERR_MITSU_UE                = 396 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // UE Probl�me Capteur de Pression HP (63HS)",
    ERR_MITSU_UF                = 397 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // UF Coupure Compresseur suite � surintent�\n(demarrage bloqu�)",
    ERR_MITSU_UH                = 398 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // UH Anomalie sur Intensit� (carte �lec. ) ",
    ERR_MITSU_UL                = 399 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // UL Pression BP trop basse",
    ERR_MITSU_UP                = 400 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // UP Compresseur en surintent�",
    ERR_MITSU_TOR               = 401 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // Erreur Module Externe (signal TOR)",
    ERR_MITSU_XX                = 402 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // D�faut Module Externe (N� d'erreur non d�fini)",
    ERR_MITSU_COM               = 403 | T_DEF_DEFAUT | DEFAUT_BLOQUANT, // D�faut Erreur Communication avec PAC",
    ERR_MITSU_TRAME_INCONNUE    = 404 | T_DEF_DEFAUT | DEFAUT_NV_IHM | DEFAUT_NV_HISTORIQUE, // D�faut reccurent de communication avec PAC",
    ERR_TIMEOUT_EMISSION        = 405 | T_DEF_DEFAUT, // D�faut reccurent pas d'�misson vers Mitsu depuis 5 mn",
...
typedef enum
{
    ...
    /*Alertes suite � d�passement de valeurs sans entrainer arret PAC, fonctionnement �ventuellement en d�grad�*/
    ...
    DEF_DEMARRAGE_C1            = 559 | T_DEF_DEFAUT | DEFAUT_NV_TH, //Pas de d�marrage sute � d�marreur progressif HS
    DEF_DEMARRAGE_C2            = 560 | T_DEF_DEFAUT | DEFAUT_NV_TH, //Pas de d�marrage sute � d�marreur progressif HS
    DEF_CHARGE_FRIGO            = 561 | T_DEF_DEFAUT | DEFAUT_NV_TH,
    /*Defauts suite � d�passement de valeurs entrainant arret PAC*/
...
typedef enum
{
    ...
    DEF_GEOINV_HYGRO_EXT             			= 203,	// Valeur remont�e par le capteur incoh�rente
	// Chauffage
...
typedef enum
{
    ...
    DEF_ARKTEA_HYGRO_EXT             			= 203,	// Valeur remont�e par le capteur incoh�rente
	// Chauffage
...
typedef enum
{
    ...
    DEF_TYPE_HYGRO_EXT             				= 203,	// Valeur remont�e par le capteur incoh�rente
	// Chauffage
