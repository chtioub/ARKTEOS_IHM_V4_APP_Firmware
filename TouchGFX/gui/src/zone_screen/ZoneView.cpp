...
ZoneView::ZoneView() :
    u16ConsigneReduit(7), u16ConsigneNormal(20), u16ConsigneConfort(22)
{
...
void ZoneView::slider_reduit(int sliderValue)
{
  ...
  textArea_jaune.moveTo(
      (int) ((float) slider_jaune.getX() + 19 /*+ slider_gris.background.getX()*/- textArea_jaune.getWidth() / 2
          + ((float) sliderValue - (float) 120) * (float) 1.98), 51);
...
void ZoneView::bouton_plus_reduit()
{
  ...
  textArea_jaune.setWildcard(textAreaBuffer_ConsigneReduit);
  textArea_jaune.moveTo(
      (int) ((float) slider_jaune.getX() + 19 /*+ slider_jaune.background.getX()*/- textArea_jaune.getWidth() / 2
          + ((float) u16ConsigneReduit - (float) 120) * (float) 1.98), 51);
  textArea_jaune.invalidate();
}
...
void ZoneView::slider_normal(int sliderValue)
{
  ...
  textArea_orange.moveTo(
      (int) ((float) slider_orange.getX() + 19 /*+ slider_orange.background.getX()*/- textArea_orange.getWidth() / 2
          + ((float) sliderValue - (float) 120) * (float) 1.98), 51);
  textArea_orange.invalidate();
  textArea_bleu_ciel.setWildcard(textAreaBuffer_ConsigneNormal);
  textArea_bleu_ciel.moveTo(
      (int) ((float) slider_bleu_ciel.getX() + 19 /*+ slider_orange.background.getX()*/- textArea_bleu_ciel.getWidth() / 2
          + ((float) sliderValue - (float) 120) * (float) 1.98), 51);
...
void ZoneView::bouton_plus_normal()
{
  ...
  textArea_orange.moveTo(
      (int) ((float) slider_orange.getX() + 19 /*+ slider_orange.background.getX()*/- textArea_orange.getWidth() / 2
          + ((float) u16ConsigneNormal - (float) 120) * (float) 1.98), 51);
  textArea_orange.invalidate();
  textArea_bleu_ciel.setWildcard(textAreaBuffer_ConsigneNormal);
  textArea_bleu_ciel.moveTo(
      (int) ((float) slider_bleu_ciel.getX() + 19 /*+ slider_orange.background.getX()*/- textArea_bleu_ciel.getWidth() / 2
...
void ZoneView::bouton_moins_normal()
{
  ...
  textArea_orange.setWildcard(textAreaBuffer_ConsigneNormal);
  textArea_orange.moveTo(
      (int) ((float) slider_orange.getX() + 19 /*+ slider_bleu_ciel.background.getX()*/- textArea_orange.getWidth() / 2
          + ((float) u16ConsigneNormal - (float) 120) * (float) 1.98), 51);
  textArea_orange.invalidate();
  textArea_bleu_ciel.setWildcard(textAreaBuffer_ConsigneNormal);
  textArea_bleu_ciel.moveTo(
      (int) ((float) slider_bleu_ciel.getX() + 19 /*+ slider_bleu_ciel.background.getX()*/- textArea_bleu_ciel.getWidth() / 2
          + ((float) u16ConsigneNormal - (float) 120) * (float) 1.98), 51);
  textArea_bleu_ciel.invalidate();
}
...
void ZoneView::slider_confort(int sliderValue)
{
  ...
  textArea_rouge.moveTo(
      (int) ((float) slider_rouge.getX() + 19 /*+ slider_bleu.background.getX()*/- textArea_rouge.getWidth() / 2
          + ((float) sliderValue - (float) 120) * (float) 1.98), 51);
  textArea_rouge.invalidate();
  textArea_bleu.setWildcard(textAreaBuffer_ConsigneConfort);
  textArea_bleu.moveTo(
      (int) ((float) slider_bleu.getX() + 19 /*+ slider_bleu.background.getX()*/- textArea_bleu.getWidth() / 2
          + ((float) sliderValue - (float) 120) * (float) 1.98), 51);
...
void ZoneView::bouton_plus_confort()
{
  ...
  textArea_rouge.setWildcard(textAreaBuffer_ConsigneConfort);
  textArea_rouge.moveTo(
      (int) ((float) slider_rouge.getX() + 19 /*+ slider_rouge.background.getX()*/- textArea_rouge.getWidth() / 2
          + ((float) u16ConsigneConfort - (float) 120) * (float) 1.98), 51);
  textArea_rouge.invalidate();
  textArea_bleu.setWildcard(textAreaBuffer_ConsigneConfort);
  textArea_bleu.moveTo(
      (int) ((float) slider_bleu.getX() + 19 /*+ slider_bleu.background.getX()*/- textArea_bleu.getWidth() / 2
