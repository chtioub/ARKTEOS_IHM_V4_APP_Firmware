...
//	txData[0].data[0] = CONTROL_WRITE;
  ...
  else if(u8RecupConfig == 3)
  {
    ...
    txData[0].data[3] = SC_RECUP_GENERAL;
  txData[0].data[4] = 0;
  txData[0].data[5] = 0;
  u16Pointeur = 6;
  u16CRC = computeCRC((uint8_t*) &txData[0].data[0], u16Pointeur);
...
void Model::c_prog_ecs(bool bEnvoi)
{
  ...
  if(bEnvoi == false)
  {
    ...
    txData[0].data[4] = sizeof(au8Prog_ECS);
  txData[0].data[5] = 0;
  u16Pointeur = 6;
  if(bEnvoi == true)
  {
...
void Model::c_prog_option(bool bEnvoi)
{
  ...
  if(bEnvoi == false)
  {
    ...
    txData[0].data[4] = sizeof(au8Prog_Options);
  txData[0].data[5] = 0;
  u16Pointeur = 6;
  if(bEnvoi == true)
  {
...
void Model::c_prog_piscine(bool bEnvoi)
{
  ...
  if(bEnvoi == false)
  {
    ...
    txData[0].data[4] = sizeof(au8Prog_Piscine);
  txData[0].data[5] = 0;
  u16Pointeur = 6;
  if(bEnvoi == true)
  {
...
void Model::c_prog_zone_chaud(uint8_t u8Zone, bool bEnvoi)
{
  ...
  if(bEnvoi == false)
  {
    ...
    txData[0].data[4] = sizeof(au8Prog_Chaud_Zx[u8Zone]);
  txData[0].data[5] = 0;
  u16Pointeur = 6;
  if(bEnvoi == true)
  {
...
void Model::c_prog_zone_froid(uint8_t u8Zone, bool bEnvoi)
{
  ...
  if(bEnvoi == false)
  {
    ...
    txData[0].data[4] = sizeof(au8Prog_Froid_Zx[u8Zone]);
  txData[0].data[5] = 0;
  u16Pointeur = 6;
  if(bEnvoi == true)
  {
...
void Model::c_prog_reg_ext_chaud(bool bEnvoi)
{
  ...
  if(bEnvoi == false)
  {
    ...
    txData[0].data[4] = sizeof(au8Prog_Regul_Ext_Chaud);
  txData[0].data[5] = 0;
  u16Pointeur = 6;
  if(bEnvoi == true)
  {
...
void Model::c_prog_reg_ext_froid(bool bEnvoi)
{
  ...
  if(bEnvoi == false)
  {
    ...
    txData[0].data[4] = sizeof(au8Prog_Regul_Ext_Froid);
  txData[0].data[5] = 0;
  u16Pointeur = 6;
  if(bEnvoi == true)
  {
