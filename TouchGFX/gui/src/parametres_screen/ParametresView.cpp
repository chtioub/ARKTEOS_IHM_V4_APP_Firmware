...
void ParametresView::changeStatutPAC(S_STATUT_PAC *sStatut_PAC)
{
	// Recup config
...
void ParametresView::changeStatutEther(S_CYC_ETHER_III *sCycEther)
{
...
void ParametresView::changeErreur(uint16_t u16Erreur)
{
...
void ParametresView::changeDate(S_DATE *sDate)
{
